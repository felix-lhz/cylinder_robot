...
class Localization(object):
    def __init__(self):
        ...
        self.y_last = np.zeros([2, 1])
        self.y_dot = np.zeros([2, 1])
    ...
    def callback_observe(self, laserscan):
        ...
        y = np.zeros([2, 1])
        y[0, 0] = 5.0 - laserscan.ranges[0]  # Assuming the first range as observation
        y[1, 0] = 5.0 - laserscan.ranges[1]  # Assuming the second range as observation
    ...
    def visualization(self):
        ...
        fig_x.savefig(fig_path+'figs/fig_x.png', dpi=120)
